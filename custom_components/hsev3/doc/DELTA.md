...
```
[FAIT] DELTA-005 → [BLOC 1 ✅] DELTA-004 Bloc 1 → [SUIVANT] Bloc 2 → Bloc 3 → Bloc 4 → DELTA-002 → DELTA-003
[FAIT] DELTA-001
...
- **Progression** :
  ...
  - 🔴 Bloc 2 **EN COURS** — `storage/manager.py` + `catalogue/` (V2) + `meta/` (V2) + `options_flow.py`
